...
alias inode='iyarn; echo $(yarn global bin); yarn global add speed-test prettier exp depcheck @playlyfe/gql --global-folder=`yarn global bin` && exp path;'
...
alias w='ls **/*.go **/*.gql | grep -v -E "vendor|models" | entr sh -c "clear && date \"+%Y-%m-%d %H:%M:%S\" && go test -v ./graphql/... . ./services/..."'
alias d='sh dev.sh'
