...
alias inode='iyarn; echo $(yarn global bin); yarn global add speed-test prettier exp bs-platform https://github.com/reasonml/reason-cli/archive/3.0.4-bin-darwin.tar.gz depcheck @playlyfe/gql --global-folder=`yarn global bin` && exp path;'
...
alias w='ls **/*.go **/*.gql | grep -v -E "vendor|models" | entr sh -c "clear && date \"+%Y-%m-%d %H:%M:%S\" && go test -v ./gql/... . ./services/..."'
alias d='sh dev.sh'
